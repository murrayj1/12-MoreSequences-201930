...
def run_test_make_simple_string():
    ...
    # Test 2 (add your test here):
    expected = '9-10-11-12-13-14-15-'
    actual = make_simple_string(9, 15)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2 (add your test here):
    expected = '9-10-11-12-13-14-15'
    actual = make_less_simple_string(9, 15)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for i in range(len(circles)):
        c_x = circles[i].center.x
        c_y = circles[i].center.y
        c_r = circles[i].radius
        list_rectangles = list_rectangles + [rg.Rectangle(rg.Point(c_x - c_r, c_y - c_r), rg.Point(c_x + c_r, c_y + c_r))]
